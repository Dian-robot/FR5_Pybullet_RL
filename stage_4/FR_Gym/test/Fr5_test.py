...
sys.path.append(r"/root/FR5_Pybullet_RL/stage_4/utils")
sys.path.append(r"/root/FR5_Pybullet_RL/stage_4/FR_Gym")
...
if __name__ == '__main__':
    ...
    env.render()
    model = PPO.load(r"/root/FR5_Pybullet_RL/stage_4/best_model.zip")
