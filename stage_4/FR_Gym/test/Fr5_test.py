...
sys.path.append(r"D:\postgraduate\project\FR_Reinforcement\stage_4\utils")
sys.path.append(r"D:\postgraduate\project\FR_Reinforcement\stage_4\FR_Gym")
...
if __name__ == '__main__':
    ...
    env.render()
    model = PPO.load(r"D:\postgraduate\project\FR_Reinforcement\stage_4\best_model.zip")
