...
sys.path.append(r"/root/FR5_Pybullet_RL/stage_3/FR_Gym/utils")
sys.path.append(r"/root/FR5_Pybullet_RL/stage_3/FR_Gym")
sys.path.append('..')
...
if __name__ == '__main__':
    ...
    env.render()
    model = PPO.load(r"/root/FR5_Pybullet_RL/stage_3/best_model.zip")
