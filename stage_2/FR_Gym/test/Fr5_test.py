...
sys.path.append(r"/root/FR5_Pybullet_RL/stage_2/FR_Gym/utils")
sys.path.append(r"/root/FR5_Pybullet_RL/stage_2/FR_Gym")
...
if __name__ == '__main__':
    ...
    env.render()
    model = PPO.load(r"/root/FR5_Pybullet_RL/stage_2/best_model.zip")
