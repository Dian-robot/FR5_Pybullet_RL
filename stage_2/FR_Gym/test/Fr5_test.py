...
sys.path.append(r"D:\postgraduate\project\FR_Reinforcement\stage_2\FR_Gym\utils")
sys.path.append(r"D:\postgraduate\project\FR_Reinforcement\stage_2\FR_Gym")
...
if __name__ == '__main__':
    ...
    env.render()
    model = PPO.load(r"D:\postgraduate\project\FR_Reinforcement\stage_2\best_model.zip")
