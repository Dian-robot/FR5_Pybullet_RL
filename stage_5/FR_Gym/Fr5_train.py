...
if __name__ == '__main__':
    ...
    # model = PPO.load(r"/home/woshihg/PycharmProjects/FR5_Reinforcement-learning_0/FR_Gym/FR5_Reinforcement-learning/models/PPO/1205-111848/best_model.zip", env=env, print_system_info=True)
    ...
    for eposide in range(1000):
        ...
        model.learn(total_timesteps=TIMESTEPS,
                    tb_log_name=f"5PPO-run-eposide{eposide}", # TensorBoard 日志运行的名称
        ...
        # 保存模型
        model.save(models_dir+f"/5PPO-run-eposide{eposide}")
